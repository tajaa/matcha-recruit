...
struct PublicCreatorCard: Codable, Identifiable, Equatable { var id: String { handle }; let handle, display_name: String; let avatar_url, cover_url, bio, location: String?; let niches: [String]; let reach_verified: Bool; let max_followers: Int; let min_rate_cents: Int?; let platforms: [String] }
struct PublicCreatorPage: Codable { let creators: [PublicCreatorCard]; let total: Int }
struct PublicCreatorProfile: Codable, Identifiable { let id, handle, display_name: String; let avatar_url, cover_url, bio, location: String?; let niches, languages: [String]; let open_to_offers, reach_verified: Bool; let reach_audited_at: String?; let socials: [CreatorSocial]; let portfolio: [CreatorPortfolioItem]; let rates: [CreatorRate] }
