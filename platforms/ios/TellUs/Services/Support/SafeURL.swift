...
///
/// Any URL that originates from network / user content (report media,
/// intake-link scans, brand logo URLs) must go through here.
/// `UIApplication.open` will launch any scheme the system can handle, so we
