"""Seed Cappe reconciliation schedulers."""
...
def upgrade() -> None:
    op.execute("""INSERT INTO scheduler_settings (task_key, display_name, description, enabled, max_per_cycle)
        VALUES ('cappe_collab_auto_approve', 'Cappe Collab Auto-Approve', 'Auto-approves overdue collab deliverables.', false, 50),
               ('cappe_domain_finalize', 'Cappe Domain Finalize', 'Re-drives domains stuck registering >15 minutes.', false, 20)
