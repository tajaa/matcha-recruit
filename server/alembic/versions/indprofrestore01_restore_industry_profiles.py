"""restore industry_compliance_profiles

The table was dropped as "unused" by zzh8i9j0k1l2 (2026-04-07) while
_get_industry_profile (compliance_service.py) and the /admin/industry-profiles
CRUD endpoints still referenced it — unnoticed because no self-serve company
had an industry set until signup began collecting one (audit E0, 2026-07-04).
Recreates the original schema + the 6 seed profiles verbatim from e6714d5d523f.

Revision ID: indprofrestore01
Revises: mfgcat01
...
revision: str = 'indprofrestore01'
down_revision = 'mfgcat01'
