    ...
    async with get_connection() as conn:
        ...
        if body.apply_to_credentials and row.get("extracted_data"):
            ...
            for field_name, field_data in fields.items():
                ...
                # Gemini returns extracted values as JSON strings, while
                # these credential columns are PostgreSQL DATEs. Ignore a
                # malformed date rather than letting asyncpg raise DataError.
                if field_name in {
                    "license_expiration",
                    "dea_expiration",
