...
| `matcha_work/` | (multiple: `/matcha-work`, `/matcha-work/public`, `/matcha-work/presence`; plus the unprefixed `tutor_sessions_router` sibling it exports but does not include) | Matcha-work projects/threads/tasks/recruiting/AI turns — **package** (split 2026-07-03, 199 routes as of the 2026-07-28 huume record-view route; see `matcha_work/CLAUDE.md`) |
