...
from ..insurance import loss_development
from ..insurance.wc_benchmarks import lookup_benchmark, estimate_premium_impact, severity_band
...
def _compute_property(snap) -> dict:
    ...
    from ..property import property_sov
