    ...
    async with get_connection() as conn:
        async with conn.transaction():
            ...
            content = (
                ...
                "`--draft-pr`, or say `you can work on this`, to require an "
                "implementation draft when AutoPR thinks the code already covers the "
                "request. Migration changes are drafted automatically, and AutoPR "
                "never runs them. Use "
