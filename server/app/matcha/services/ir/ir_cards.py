...
Moved here from ``routes/ir_incidents/_cards.py`` (refactor round 2, stage 3):
the pure ``build_*_card`` factories, their constants (OSHA injury types,
emergency-alert copy, root-cause prompt labels) and ``compose_root_cause_text``.
