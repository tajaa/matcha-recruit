...
from app.matcha.services.scheduling.schedule_eligibility import open_expired_eligibility_cases
...
async def _dispatch() -> dict:
    ...
    try:
        ...
        return {"opened": opened, "companies": len(companies)}
    finally:
        await conn.close()
