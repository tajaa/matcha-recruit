...
- `gemini-3.1-flash-lite` legacy call sites (recruiting, thread_uploads,
  ...
  silent bump to the fleet Flash Lite tier would change their cost profile.
...
# extractions. The API account currently exposes 3.5 Flash Lite for
# `generateContent`; 3.7 Flash Lite is not an available model id. CANONICAL
# NOTE (other modules point here rather than re-stating this): the 3.x
# generation dropped `thinking_budget`;
