...
_INDUSTRY_POLICY_TYPES: List[dict] = [
    ...
    # Behavioral health facility-specific policies
    {"value": "bh_seclusion_restraint", "label": "Seclusion and Restraint",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover 42 CFR 482.13 requirements: criteria for initiating seclusion/restraint, least restrictive intervention hierarchy, 1-hour face-to-face evaluation requirement, time-limited orders (4h adult/2h child/1h under 9), continuous monitoring, documentation, debriefing, staff training, and patient rights notification. Include state-specific rules (e.g., CA WIC 5585)."},
    {"value": "bh_suicide_prevention", "label": "Suicide Risk Assessment and Prevention",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover Joint Commission NPSG 15.01.01: screening all patients for suicidal ideation using validated tools (PHQ-9, C-SSRS), environmental safety assessments (ligature risk), 1:1 observation protocols, safety planning, means restriction counseling, transition/discharge safety planning, and staff training requirements. Reference Zero Suicide framework."},
    {"value": "bh_involuntary_commitment", "label": "Involuntary Psychiatric Hold Procedures",
     "categories": ["reproductive_behavioral"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover state-specific involuntary commitment procedures (CA 5150/5250, FL Baker Act, NY Mental Hygiene Law 9.39). Include criteria for initiation (danger to self/others, gravely disabled), required documentation, patient rights notification, hearing timelines, release criteria, and transfer protocols. Include interactions with law enforcement."},
    {"value": "bh_42cfr_part2", "label": "42 CFR Part 2 — SUD Confidentiality",
     "categories": ["reproductive_behavioral"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover federal confidentiality protections for substance use disorder treatment records under 42 CFR Part 2 (2024 final rule aligning with HIPAA for TPO). Include consent requirements, qualified service organization agreements (QSOAs), court-ordered disclosures, medical emergencies exception, audit/evaluation exception, research disclosures, breach notification, and penalties for unauthorized disclosure."},
    {"value": "bh_mental_health_parity", "label": "Mental Health Parity Compliance (MHPAEA)",
     "categories": ["reproductive_behavioral"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover Mental Health Parity and Addiction Equity Act requirements: non-quantitative treatment limitation (NQTL) analysis, parity in copays/deductibles/visit limits between MH/SUD and medical/surgical benefits, network adequacy, prior authorization parity, compliance documentation requirements. Include 2024 final rule changes and state parity laws."},
    {"value": "bh_informed_consent_mh", "label": "Informed Consent for Behavioral Health Treatment",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover informed consent specific to behavioral health: psychotropic medication consent (risks, alternatives, right to refuse), electroconvulsive therapy consent, behavioral interventions consent, minors and consent capacity, substituted judgment for incapacitated patients, voluntary vs involuntary treatment consent, right to withdraw consent. Include state-specific rules for minors consenting to MH/SUD treatment."},
    {"value": "bh_patient_rights_grievance", "label": "Patient Rights and Grievance Procedures",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover 42 USC 9501 Bill of Rights for MH patients: right to treatment in least restrictive setting, right to individualized treatment plan, right to refuse treatment, right to communication/visitation, right to confidentiality, grievance filing procedures, patients' rights advocate role, investigation timelines, retaliation protections. Include CMS Conditions of Participation requirements."},
    {"value": "bh_treatment_planning", "label": "Individualized Treatment Planning",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover requirements for individualized treatment plans: initial assessment within 24-72 hours, treatment plan development within 10 days of admission, measurable goals and objectives, patient/family participation, interdisciplinary team review, 90-day treatment plan updates, discharge criteria, ASAM criteria for SUD level-of-care placement, and evidence-based practice requirements."},
    {"value": "bh_discharge_transition", "label": "Discharge and Transition Planning",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover discharge planning for behavioral health: discharge criteria, warm handoff protocols, 7-day post-discharge follow-up requirement, medication reconciliation at discharge, relapse prevention planning, peer support linkage, outpatient referrals, housing and social services coordination, continuity of care documentation, and HEDIS follow-up measures."},
    {"value": "bh_samhsa_otp_compliance", "label": "SAMHSA OTP and MAT Program Compliance",
     "categories": ["reproductive_behavioral"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover SAMHSA Opioid Treatment Program (OTP) certification requirements: 42 CFR 8 compliance, methadone dispensing protocols, take-home dose criteria, counseling service minimums, drug testing frequency, admission criteria, diversion control plans, physician waiver requirements for buprenorphine (X-waiver elimination under MAT Act), MOUD integration, and state OTP licensing requirements."},
    {"value": "bh_facility_licensing", "label": "Behavioral Health Facility Licensing",
     "categories": ["state_licensing"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover state behavioral health facility licensing requirements (DHCS in CA, OMH in NY, AHCA in FL): licensure categories (residential, outpatient, crisis stabilization, partial hospitalization, IOP), physical plant requirements, staffing ratios, fire safety, ADA compliance, annual inspection preparation, deficiency correction plans, and license renewal procedures."},
    {"value": "bh_workforce_credentialing", "label": "Behavioral Health Workforce Credentialing",
     "categories": ["healthcare_workforce"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover credentialing requirements for behavioral health staff: LCSW/LMFT/LPC/LPCC licensing verification, BCBA certification, CADC/CASAC substance abuse counselor certification, psychiatric NP furnishing numbers, peer support specialist certification, supervision requirements for pre-licensed staff, continuing education requirements, OIG/SAM exclusion screening, primary source verification, and credentialing committee processes."},
    {"value": "bh_incident_reporting", "label": "Critical Incident Reporting",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover behavioral health incident reporting: definitions of reportable events (elopement, AWOL, self-harm, patient-on-patient violence, medication errors, restraint injuries, deaths), internal reporting timelines, state reporting requirements (e.g., CA Title 22 unusual occurrence reports), root cause analysis procedures, corrective action plans, and sentinel event reporting to Joint Commission/CARF."},
    {"value": "bh_trauma_informed_care", "label": "Trauma-Informed Care",
     "categories": ["clinical_safety"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover SAMHSA's six principles of trauma-informed care: safety, trustworthiness/transparency, peer support, collaboration/mutuality, empowerment/voice/choice, cultural/historical/gender issues. Include universal trauma screening, staff training requirements, trauma-sensitive environment design, secondary traumatic stress support for staff, and integration with evidence-based trauma treatments (CPT, PE, EMDR)."},
    {"value": "bh_co_occurring_disorders", "label": "Co-Occurring Disorders (Dual Diagnosis)",
     "categories": ["reproductive_behavioral"], "industries": ["healthcare:behavioral_health"],
     "scope_guidance": "Cover integrated treatment requirements for co-occurring mental health and substance use disorders: screening protocols (e.g., AUDIT, DAST, PHQ-9), integrated treatment planning, no-wrong-door approach, staff cross-training requirements, medication management across conditions, ASAM/LOCUS level-of-care determination, and coordination with primary care."},
