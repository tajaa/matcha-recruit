...
from app.core.services.handbook_service import GuidedDraftRateLimitError, HandbookService, derive_handbook_scopes_from_employees
...
async def mark_section_reviewed(
    ...
    from app.core.models.handbook import HandbookSectionResponse
    from app.core.services.handbook_service import _coerce_jurisdiction_scope
