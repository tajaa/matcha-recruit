...
class IsrcConfig(Base, TimestampMixin):
    __tablename__ = "oceanlab_isrc_config"
...
class UpcCode(Base, TimestampMixin):
    __tablename__ = "oceanlab_upc_codes"
    ...
    release_id: Mapped[uuid.UUID | None] = mapped_column(
        sa.Uuid(as_uuid=True), sa.ForeignKey("oceanlab_releases.id", ondelete="SET NULL"), nullable=True
    )
