...
import { ClassificationEditor } from './AuthorityCockpit/ClassificationEditor'
import { FunnelBar } from './AuthorityCockpit/FunnelBar'
import { DISPOSITION_BADGE, pct } from './AuthorityCockpit/constants'
import type {
  AuthorityIndex,
  AuthorityItem,
  ShadowRow,
