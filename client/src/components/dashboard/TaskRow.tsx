  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className={`text-sm truncate ${isCompleted ? 'line-through text-zinc-500' : 'text-zinc-100'}`}>
          {item.title}
        </div>
        {item.subtitle && (
      ...
      <span className="shrink-0 px-2 py-0.5 text-[10px] font-medium rounded-full bg-white/[0.06] text-zinc-400">
