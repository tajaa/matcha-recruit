...
const navSections: NavSection[] = [
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Companies',
        roles: ['admin'],
        helpText: 'View and edit company profiles, industry, specialties, and users.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
          </svg>
...

  {
    ...
    items: [
      ...
      {
        path: '/app/matcha/training',
        label: 'Training',
        roles: ['admin', 'client'],
        platformKey: 'training',
        feature: 'training',
        helpText: 'Manage training requirements and track employee compliance.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
          </svg>
      ...
      },
      {
        ...
        platformKey: 'i9',
        feature: 'i9',
        helpText: 'Track I-9 employment eligibility verification and document expiration.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        path: '/app/matcha/pre-termination',
        label: 'Pre-Termination',
        roles: ['admin', 'client'],
        platformKey: 'employees',
        feature: 'employees',
        helpText: 'Progressive discipline, agency charges, and post-termination claims.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        path: '/app/matcha/cobra',
        label: 'COBRA',
        roles: ['admin', 'client'],
        platformKey: 'cobra',
        feature: 'cobra',
        helpText: 'Track COBRA qualifying events, notices, and election deadlines.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        path: '/app/matcha/separations',
        label: 'Separations',
        roles: ['admin', 'client'],
        platformKey: 'separation_agreements',
        feature: 'separation_agreements',
        helpText: 'Manage separation agreements with ADEA/OWBPA compliance tracking.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
...

  {
    ...
    items: [
      ...
      {
        path: '/app/admin/jurisdiction-data',
        label: 'Jurisdiction Data',
        roles: ['admin'],
        platformKey: 'jurisdictions',
        helpText: 'Data quality dashboard for jurisdiction compliance repository.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
