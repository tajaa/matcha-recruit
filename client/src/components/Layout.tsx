...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      {
        path: '/app/matcha/setup',
        label: 'Setup',
        roles: ['admin', 'client'],
        helpText: 'Connect Google Workspace and future integrations like Slack and Toast for this business.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: '/app/admin/poster-orders',
        label: 'Poster Orders',
        roles: ['admin'],
        helpText: 'Manage compliance poster print requests from companies.',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
