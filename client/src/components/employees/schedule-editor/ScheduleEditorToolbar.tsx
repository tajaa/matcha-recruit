  ...
  return (
    <div className="border-b border-white/[0.06] bg-zinc-950/90 px-3 py-3 backdrop-blur md:px-5">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button onClick={onToggleChat} className={`inline-flex items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs ${chatOpen ? 'border-emerald-500/50 text-emerald-300' : 'border-zinc-800 text-zinc-400 hover:text-zinc-100'}`} title="Ask about this schedule"><Sparkles className="h-3.5 w-3.5" /> Ask</button>
