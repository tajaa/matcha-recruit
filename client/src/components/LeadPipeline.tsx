                                        ...
                                        {status === 'staging' && (
                                            <div className="flex flex-col gap-2 w-full">
                                                ...
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        leadsAgent.researchContact(lead.id).then(() => fetchPipeline());
                                                    }}
                                                    className="w-full py-1.5 bg-zinc-800 hover:bg-zinc-700 text-[9px] text-zinc-300 font-bold uppercase tracking-widest rounded border border-zinc-700 transition-colors flex items-center justify-center gap-2"
                                                >
