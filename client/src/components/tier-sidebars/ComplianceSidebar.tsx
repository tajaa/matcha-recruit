import { Building2, CalendarClock, FileText, Shield, Users, Zap } from 'lucide-react'
...
// bundle granted by the matcha_compliance TIER_REQUIRED overlay. Each nav item
// is feature-gated so it only renders when its overlay flag is on — the pending
// shell handles the unpaid state upstream. Credential templates intentionally
// remain exclusive to the Matcha client surfaces.
