        ...
        <BrowserRouter>
          <Suspense fallback={<PageLoader />}>
            ...
            >
              ...
              />
              <Route
                path="matcha/slack-provisioning"
                element={
                  <ProtectedRoute roles={['admin', 'client']}>
                    <SlackProvisioning />
                  </ProtectedRoute>
              ...
              />
              <Route
                path="admin/legislative-tracker"
                element={
                  <ProtectedRoute roles={['admin']}>
                    <LegislativeTracker />
                  </ProtectedRoute>
              ...
              />
              <Route
                path="admin/candidate-metrics/:id"
                element={
                  <ProtectedRoute roles={['admin', 'client']} requiredFeature="interview_prep">
                    <TutorSessionDetail />
                  </ProtectedRoute>
