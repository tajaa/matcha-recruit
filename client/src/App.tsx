...
const OutreachScreening = lazy(() => import('./pages/OutreachScreening'));
...
const JobBoards = lazy(() => import('./pages/JobBoards'));
const ResumeOnboarding = lazy(() => import('./pages/ResumeOnboarding'));
