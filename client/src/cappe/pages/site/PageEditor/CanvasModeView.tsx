  ...
  return (
    <div className="relative flex min-h-0 flex-1">
      ...
      {/* floating editor — anchored to the clicked element when selected,
          else a corner card with the Add affordance + hint. Canvas mode and
          Merlin are mutually exclusive editing surfaces now (index.tsx only
          renders this view when Merlin is closed), so this no longer needs
          to suppress itself for an open Merlin panel. */}
      <div
