...
import { useLanguageTutorPanel } from './useLanguageTutorPanel'
...
export default function LanguageTutorPanel({ threadId, lightMode, currentState, onStateUpdate }: LanguageTutorPanelProps) {
  const {
    bg, fg, muted, cardBg, border,
    phase, language, setLanguage, duration, setDuration,
    transcripts, sessionInfo, analysis, error, starting, expandedSections, inlineErrors,
    transcriptEndRef, voice,
    handleStart, handleNewSession, toggleSection, handleSessionEnded,
  } = useLanguageTutorPanel({ threadId, lightMode, currentState, onStateUpdate })
