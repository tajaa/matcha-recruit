...
export const THREAD_MODE_TOGGLES: {
  ...
  { key: 'huume', label: 'Huume', icon: Bot, onClass: 'bg-orange-600 text-white hover:bg-orange-500', badgeClass: 'bg-orange-700 text-orange-200', tipOn: 'Huume ON — agentic onboarding: drafts offers, stages hiring plans, waits for your approval before it acts', tipOff: 'Huume OFF', feature: 'huume' },
]
