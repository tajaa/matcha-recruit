              ...
              <td className="px-3 py-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-0.5 text-[10px] text-w-faint">{item.auto_created ? 'Auto-created from channel activity' : 'Manually managed'}</div>
                  </div>
                </div>
              </td>
              <td className="px-3 py-2">
                ...
                <div className="mt-0.5 text-[10px] text-w-faint">{item.unit ?? 'units'}</div>
              </td>
              <td className="px-3 py-2 text-w-dim">{item.low_stock_threshold ?? 'Not set'}</td>
              <td className="px-3 py-2 text-w-dim">{item.location_name ?? 'Company-wide'}</td>
              <td className="px-3 py-2">
                {item.open_order ? (
