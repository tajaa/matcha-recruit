...
import {
  ...
  TrendingUp, TrendingDown, Minus, Plus, Trash2, Gauge, HeartPulse, Boxes, Sparkles, FileDown, Download, Upload,
} from 'lucide-react'
...
import {
  ...
  fetchClientLimitAdequacy, downloadClientLimits,
...
import type { LossDevelopment, LossRunDraftPeriod, LossRatioData, LossRatioRow, LossPremiumBody } from '../../types/lossDevelopment'
...
/* ──────────────────── Loss Development / Triangulation Tab ──────────────────── */

function LossTriangleTab({ companyId }: { companyId: string }) {
...
/* ──────────────────── Limit Adequacy / Contract Review Tab ──────────────────── */

function LimitsTab({ companyId }: { companyId: string }) {
