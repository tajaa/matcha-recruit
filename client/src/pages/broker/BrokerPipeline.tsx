...
export default function BrokerPipeline({ embedded = false }: { embedded?: boolean }) {
    ...
    <div className="space-y-5">
      {!embedded && (
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">Onboarding stages across your referred clients.</p>
        </div>
      )}
