...
export function Careers() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-mono selection:bg-matcha-500 selection:text-black">
      {/* Grid background */}
      ...
      {/* Header */}
      <header className="relative z-10 border-b border-zinc-800/50 bg-zinc-950/90 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link
            to="/login"
            className="text-[10px] tracking-[0.15em] uppercase text-zinc-500 hover:text-matcha-400 transition-colors"
          >
            Login
          </Link>
        </div>
      ...
      {/* Hero */}
      <section className="relative z-10 py-16 border-b border-zinc-800/50">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold tracking-[-0.02em] text-white mb-3">CAREERS</h1>
          <p className="text-[11px] tracking-[0.3em] uppercase text-zinc-500">
            Join Our Partner Companies
          </p>
          <p className="mt-6 text-zinc-400 max-w-xl mx-auto text-sm leading-relaxed">
            Browse open positions from innovative companies using Matcha Recruit.
            Find your next opportunity and apply directly.
          </p>
        </div>
      </section>

      {/* Filters */}
      <section className="relative z-10 py-6 border-b border-zinc-800/50 bg-zinc-900/30">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <select
              ...
              className={`${inputClasses} appearance-none cursor-pointer min-w-[150px]`}
              style={{
                    ...
                    <div className="bg-zinc-900/50 border border-zinc-800 p-6 group-hover:border-zinc-700 transition-colors">
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                        ...
                        <div className="flex flex-col items-end gap-3">
                          ...
                          <Link
                            to={`/login?redirect=/app/positions/${position.id}`}
