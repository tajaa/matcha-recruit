// Design tokens for the simplified /platform page. One green accent used the
...
export const GREEN = '#A3C57D' // the one emphasis color — everything else stays grayscale
export const GREEN_600 = '#5B7F3E' // eyebrow labels specifically
