import { AMBER, ASH, BONE, DISPLAY, LEAF, LINE_D, SURFACE } from '../../home/theme'
          ...
          <div className="mt-10 grid sm:grid-cols-3 gap-px rounded-xl overflow-hidden" style={{ backgroundColor: LINE_D }}>
            {CARDS.map((c) => (
              <div key={c.label} className="p-7" style={{ backgroundColor: SURFACE }}>
                ...
                <div className="text-[2.25rem] tabular-nums" style={{ fontFamily: DISPLAY, fontWeight: 300, color: c.color, lineHeight: 1 }}>
                  {c.value}
                </div>
