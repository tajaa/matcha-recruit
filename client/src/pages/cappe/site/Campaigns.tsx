          ...
          {campaigns.map((c) => (
            <div key={c.id} className="flex items-center gap-4 px-5 py-3">
              <div className="min-w-0 flex-1">
                <div className="truncate font-medium text-zinc-900">{c.subject}</div>
              ...
              {c.status !== 'sent' && c.status !== 'sending' && (
                <button onClick={() => send(c)} className="flex items-center gap-1 text-xs font-medium text-emerald-700 hover:underline">
