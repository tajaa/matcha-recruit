 ...
 *
 * One page for every such product: the definition (name, blurb, included
...
export default function ProductSignup() {
    ...
    return (
      <div className="min-h-screen bg-[#0c0c0e] flex items-center justify-center px-4">
        <div className="text-center">
          <h1 className="text-xl font-semibold text-zinc-100 mb-2">Product not available</h1>
          <p className="text-sm text-zinc-400">
            This signup link isn't active. <a href="mailto:hello@matcha.work" className="underline">Contact us</a>.
          </p>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-screen bg-[#0c0c0e] flex items-center justify-center px-4">
        <div className="max-w-sm text-center">
          <h1 className="text-xl font-semibold text-zinc-100 mb-2">{product.name}</h1>
  ...
  const included = product.features
    .map((f) => PRODUCT_NAV_CATALOG[f]?.label)
    ...
    <div className="min-h-screen bg-[#0c0c0e] flex items-center justify-center px-4 py-12">
      <div className="max-w-sm w-full">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-semibold text-zinc-100 mb-2">{product.name}</h1>
