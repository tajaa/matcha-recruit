...
export const EEO_STATEMENT = EEO
...
export const JD_CONTENT: Record<string, JDContent> = {
  ...
  'line-cook': {
    summary: 'The Line Cook prepares and plates menu items to recipe specifications in a high-volume kitchen environment. You will manage your station from prep through service, maintain food safety standards, and work in close coordination with the BOH team to deliver consistent quality under pressure.',
    responsibilities: [
  ...
  'prep-cook': {
    summary: 'The Prep Cook supports culinary operations by completing advance preparation tasks that allow line cooks to execute service efficiently. You will handle knife work, batch cooking, and stock and sauce production while upholding the highest standards of food safety and sanitation.',
    responsibilities: [
  ...
  'server': {
    summary: 'The Server delivers an exceptional dining experience from greeting through farewell. You will guide guests through menus, manage orders accurately in the POS system, handle payments, and upsell thoughtfully — all while maintaining a warm, attentive presence that turns first-time guests into regulars.',
    responsibilities: [
  ...
  'bartender': {
    summary: 'The Bartender crafts cocktails, manages the bar environment, and provides exceptional guest service. You will maintain product knowledge across spirits, wine, and beer, serve alcohol responsibly, track inventory, and create an engaging bar atmosphere that drives repeat visits.',
    responsibilities: [
  ...
  'host': {
    summary: 'The Host/Hostess is the first and last impression of the dining experience. You will manage reservations, greet guests, quote wait times accurately, and coordinate seating to maximize dining-room flow — all while maintaining a warm, polished presence that sets the tone for the entire meal.',
    responsibilities: [
  ...
  'dishwasher': {
    summary: 'The Dishwasher is an essential part of the kitchen team, ensuring clean, sanitized dishware, cookware, and utensils are always available for service. You will maintain the dish station, support kitchen cleanliness, and assist with basic food prep as needed.',
    responsibilities: [
  ...
  'shift-leader': {
    summary: 'The Shift Leader oversees operations during an assigned shift in a restaurant or QSR environment. You will manage the team on the floor, ensure food safety compliance, handle cash and deposits, and deliver consistent guest service — serving as the on-shift authority in the absence of the General Manager.',
    responsibilities: [
  ...
  'general-manager-restaurant': {
    summary: 'The Restaurant General Manager leads all aspects of restaurant operations to maximize guest satisfaction, team performance, and financial results. You will control food and labor costs, develop your team, enforce brand and safety standards, and build a culture of hospitality and accountability.',
    responsibilities: [
  ...
  'delivery-driver': {
    summary: "The Delivery Driver represents the brand at the customer's door and ensures food arrives on time, at the correct temperature, and in perfect condition. You will manage your delivery route efficiently, handle payments where applicable, and maintain your vehicle in safe operating condition.",
    responsibilities: [
