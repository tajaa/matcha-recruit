...
const LT = {
  ...
  changeCard: 'bg-zinc-900 rounded-xl shadow-lg border border-white/5',
  changeSection: 'text-zinc-400 font-bold',
  changeDate: 'text-zinc-500',
  changeRationale: 'text-zinc-300',
  changeProposedLabel: 'text-zinc-500 font-bold',
  changeProposedText: 'text-zinc-100',
  jumpBtn: 'border border-white/10 hover:border-white/20 text-zinc-400 hover:text-white rounded-lg',
