...
export default function PerformanceReviews() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <LifecycleWizard
        steps={REVIEW_CYCLE_STEPS}
        activeStep={cycles.length > activeCycles.length ? 5
                  : activeCycles.length > 0 ? 3
                  : templates.length > 0 ? 2
                  : 1}
        title="Review Cycle"
        storageKey="review-wizard-collapsed-v1"
      />
