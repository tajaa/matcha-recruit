...
export default function VibeChecks() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <LifecycleWizard
        steps={VIBE_CYCLE_STEPS}
        activeStep={responses.length > 10 ? 5
                  : responses.length > 0 ? 4
                  : (config?.enabled ?? false) ? 2
                  : 1}
        title="Vibe Cycle"
        storageKey="vibe-wizard-collapsed-v1"
      />
