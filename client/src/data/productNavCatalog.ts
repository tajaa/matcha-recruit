...
export const PRODUCT_NAV_CATALOG: Record<string, ProductNavEntry> = {
  ...
  employee_schedule: { to: '/ops/schedule', icon: CalendarDays, label: 'Schedule' },
  schedule_intelligence: { to: '/ops/schedule-intelligence', icon: BarChart3, label: 'Schedule Intelligence' },
  ...
  matcha_ops: { to: '/ops', icon: Boxes, label: 'Matcha Ops' },
