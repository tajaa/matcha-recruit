...
// The legacy-mode types below predate that rule and are tracked debt; don't
// add to them piecemeal.
import type { CitationRecord, PilotStep, AgentChatResult, AgentChatHandlers } from '../../types/compliancePilot'
