...
| `ems` | ❌ | EMS — "@huume <what happened>" in any channel logs a structured event; admin promotes to a real IR incident (AI never auto-creates). Needs `matcha_work`. → `server/app/matcha/services/ems/CLAUDE.md` |
